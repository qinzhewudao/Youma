...
<body>  
<div class="my_info_title">电子合同</div>

<div class="my_info_title_3">
  <ul>
    <li id="listClick_6" onClick="listClick(6)">发布的的项目</li>
    <li id="listClick_7" onClick="listClick(7)">投标的项目</li>
     <li id="listClick_5" onClick="listClick(5)"style="border-bottom: 1px solid #C40521; color: #C40521;">我的合同</li>
  </ul>
</div><br><br>
<div class="demo">
        ...
        <tbody>
         ...
         <tr>        
                  ...
                  <td>    <s:property value="#c.publisher" /></td>
                    ...
                    <td>  <s:property value="#c.contractdate" /></td>

              <td> <a class="grid__item" href = "contractdetail.action?projectname=<s:property value="#c.projectname"/>&publisher=<s:property value="#c.projectname"/>&bidder=<s:property value="#c.bidder" />">
                                                                                           点击可获得word合同
                        </a></td>
                    </s:iterator>
                    </ul>
