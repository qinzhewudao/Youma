...
function listClick(value){
	...
	if(value == 2){
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/make_head.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 3){
		...
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/identity_prove.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 8){
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/my_account.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 9){
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/investment_inquiry.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 10){
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/apply_refund.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 11){
		...
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/grade_integration.jsp");
	...
	if(value == 12){
		...
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/integration_record.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 13){
		...
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/integration_rule.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 14){
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/messages.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 15){
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/inbox.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 16){
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/outbox.jsp");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
