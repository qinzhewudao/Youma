<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
			<img alt="140x140" src="img/a.jpg" /> <button class="btn" type="button">按钮</button>
	...
	<div class="row-fluid">
		<div class="span12">
			...
			</div> <span class="badge">1</span> <span class="label">文字标签</span>
	...
	<div class="row-fluid">
		<div class="span12">
			 <a id="modal-994740" href="#modal-container-994740" role="button" class="btn" data-toggle="modal">触发遮罩窗体</a>
			
			<div id="modal-container-994740" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="accordion" id="accordion-160956">
				<div class="accordion-group">
					<div class="accordion-heading">
						 <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-160956" href="#accordion-element-365961">选项卡 #1</a>
					</div>
					<div id="accordion-element-365961" class="accordion-body collapse in">
				...
				<div class="accordion-group">
					<div class="accordion-heading">
						 <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-160956" href="#accordion-element-800971">选项卡 #2</a>
					</div>
					<div id="accordion-element-800971" class="accordion-body collapse">
						<div class="accordion-inner">
							功能块...
						</div>
					</div>
			...
			<div class="carousel slide" id="carousel-43425">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-43425">
					</li>
					<li data-slide-to="1" data-target="#carousel-43425">
					</li>
					<li data-slide-to="2" data-target="#carousel-43425">
					</li>
				</ol>
				...
				</div> <a data-slide="prev" href="#carousel-43425" class="left carousel-control">‹</a> <a data-slide="next" href="#carousel-43425" class="right carousel-control">›</a>
			</div>
			<div class="tabbable" id="tabs-559280">
				<ul class="nav nav-tabs">
					<li class="active">
						<a href="#panel-841833" data-toggle="tab">第一部分</a>
					</li>
					<li>
						<a href="#panel-554738" data-toggle="tab">第二部分</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="panel-841833">
						<p>
							第一部分内容.
						</p>
					</div>
					<div class="tab-pane" id="panel-554738">
						<p>
							第二部分内容.
						</p>
					</div>
